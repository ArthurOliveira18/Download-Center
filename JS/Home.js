...
const drivers = [
    {
        marca: "Daruma",
        modelos: [
            { nome: "DR800", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/DARUMA_DR800_Driver_USB.zip" },
            { nome: "DR700", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/Driver-Daruma-DR700.zip" }
        ]
    },
    {
        marca: "Epson",
        modelos: [
            { nome: "TM-T20", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/driver-epson-tm-t20-tm-t20x.zip" },
            { nome: "TM-T20X", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/driver-epson-tm-t20-tm-t20x.zip" }
        ]
    },
    {
        marca: "Bematech",
        modelos: [
            { nome: "Bematech 4200 TH", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/BEMA_MP_4200_TH_32.zip" },
            { nome: "Bematech MP-2800 TH", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/Bematech_MP-2800_TH_v1.3.zip" }
        ]
    },
    {
        marca: "Elgin",
        modelos: [
            { nome: "Elgin i9", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/ELGIN_i9_e_i7_Driver_Spooler.zip" },
            { nome: "Elgin i8", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/imgCard_2a2228fd-72b1-4b99-8b66-8177650aaef5_i8_Windows.Driver_V7.17.rar" },
            { nome: "Elgin i7", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/ELGIN_i9_e_i7_Driver_Spooler.zip" },
        ]
    },
    {
        marca: "Generico (POS-58/POS-80)",
        modelos: [
            { nome: "POS-58", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/POS_58_Driver-11.3.0.0.zip" },
            { nome: "POS-80", link: "https://github.com/ArthurOliveira18/Download-Center/releases/download/drivers/POS_58_Driver-11.3.0.0.zip" },
        ]
    }
];
